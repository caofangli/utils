...
public class ReadDataUtil {
    ...
    public com.cfl.oneself.utils.learning.socktrpc.ReadData getInstance(){
        Proxy.newProxyInstance(com.cfl.oneself.utils.learning.socktrpc.ReadData.class.getClassLoader(), new Class[]{ReadData.class},
                new InvocationHandler() {
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        ...
                        if(name.equals("findProductById")){
                            ...
                            com.cfl.oneself.utils.learning.socktrpc.Product p = (com.cfl.oneself.utils.learning.socktrpc.Product)ois.readObject();
                            ois.close();
                            in.close();
                            out.close();
                            sc.close();
                            ...
                            ObjectInputStream ois = new ObjectInputStream(in);
                            com.cfl.oneself.utils.learning.socktrpc.Product p = (Product)ois.readObject();
                            ois.close();
                            in.close();
                            out.close();
                            sc.close();
